class TexturedCube extends Shape {
  constructor(textureNum, baseColor, texColorWeight) {
    ...
    this.verticesAndUVs = new Float32Array([
      ...
      // right
      0.5,-0.5,-0.5,0,0, 0.5,0.5,-0.5,0,1, 0.5,-0.5,0.5,1,0, 0.5,0.5,0.5,1,1, 0.5,0.5,-0.5,0,1, 0.5,-0.5,0.5,1,0,
      // left
      -0.5,-0.5,-0.5,1,1, -0.5,0.5,-0.5,0,1, -0.5,-0.5,0.5,1,0, -0.5,0.5,0.5,0,0, -0.5,0.5,-0.5,0,1, -0.5,-0.5,0.5,1,0,
      // front
